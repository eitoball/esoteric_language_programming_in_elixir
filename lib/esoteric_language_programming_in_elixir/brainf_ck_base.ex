defmodule EsotericLanguageProgrammingInElixir.BrainfCkBase do
  defmacro __using__(opts) do
    quote do
      ...
      defp analyze_jumps(tokens, pos, jumps, _stack) when length(tokens) <= pos do
        jumps
      end
      ...
      defp analyze_jumps(tokens) do
        analyze_jumps(tokens, 0, %{}, [])
      end
    end
  end
end
